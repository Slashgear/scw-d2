      ...
      <main className="mx-auto max-w-3xl space-y-8 px-4 py-10">
        ...
        <Section title="The prompt">
          <button
            ...
            className="rounded-md border border-slate-500 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:border-slate-400 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
          >
