    ...
    <div className="flex h-screen w-screen flex-col bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <header className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 px-4 py-2 dark:border-slate-800">
        ...
        <div className="flex flex-wrap items-center gap-4">
          {/* Core controls — act on the diagram/session itself. */}
          <div className="flex flex-wrap items-center gap-2">
            <select
              ...
              className="h-8 rounded-md border border-slate-500 bg-white px-2 text-xs font-medium text-slate-700 hover:bg-slate-100 dark:border-slate-400 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
            >
            ...
            <button
              type="button"
              onClick={toggleTheme}
              className="rounded-md border border-slate-500 px-3 py-1 text-xs font-medium text-slate-600 hover:bg-slate-100 dark:border-slate-400 dark:text-slate-300 dark:hover:bg-slate-800"
            >
              {theme === 'dark' ? 'Light mode' : 'Dark mode'}
            </button>
          </div>

          <div className="hidden h-5 w-px bg-slate-200 sm:block dark:bg-slate-800" aria-hidden="true" />

          {/* Secondary/meta — navigate away from the editor entirely. */}
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              ...
              className="rounded-md border border-slate-500 p-1.5 text-slate-600 hover:bg-slate-100 dark:border-slate-400 dark:text-slate-300 dark:hover:bg-slate-800"
            >
