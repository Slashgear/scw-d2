      ...
      <header className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 px-4 py-2 dark:border-slate-800">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <select
            ...
            className="h-8 rounded-md border border-slate-500 bg-white px-2 text-xs font-medium text-slate-700 hover:bg-slate-100 dark:border-slate-500 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
          >
          ...
          <a
            ...
            className="rounded-md border border-slate-500 p-1.5 text-slate-600 hover:bg-slate-100 dark:border-slate-500 dark:text-slate-300 dark:hover:bg-slate-800"
          >
